...
//   useEffect(() => {
//     fetch(`http://127.0.0.1:8000/api/place/${slug}`)
...
//     axios
//       .put(`${process.env.REACT_APP_API_URL}/api/place/${slug}`, formData, config)
//       .then((res) =>{
//         console.log(res);
//         setShowModal(true);
//       })
      ...
      <div className="contribute-container">
        ...
        <div className="right-part">
          <div className="place-info">
            ...
            <div className="review-text">Your review of the place</div>
            <div className="review">
              <RatingStars sendRating={handleRating} initialValue={placedetails.rating} /> {/* Set initial rating */}
            </div>
            <div className="review-box">
              <input
                type="text"
