...
class PlaceSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Place
        fields = ('id', 'name', 'description', 'offering', 'latitude', 'longitude', 'metalatitude', 'metalongitude', 'location', 'c_review', 'slug', 'is_verified', 'contributor', 'rating', 'contributor_name', 'images', 'email')
